    ...
    left: 0;
        ...
        <div class="slider-container overlay">
            ...
            <div id="mainSlider" class="nivoSlider slider-image">
                <img src="images/slide2.jpeg" alt="Grand Arena" title="#htmlcaption1" />
                <img src="images/slide1.jpeg" alt="Grand Arena" title="#htmlcaption2" />
                <img src="images/slide3.jpeg" alt="Grand Arena" title="#htmlcaption4" />
                <img src="img/slider/1.jpg" alt="Haritha Vanam" title="#htmlcaption3" />
                <!-- <img src="img/slider/3.jpg" alt="" title="#htmlcaption6" /> -->
                <img src="img/slider/3.jpg" alt="Fortune heights" title="#htmlcaption5" />
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-12 col-12 fadeInLeft wow welcome-pd mb-3" data-wow-delay="0.2s">
                        ...
                        <a href="about-us.php">Read More <i class="fa fa-angle-double-right"></i></a>

                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-12 col-12 mb-3">
                        <div class="welcome-haven-img fadeInRight wow text-left" data-wow-delay="0.2s">
                            <img src="images/vision_no_transparent.png" alt="Vision" style="width: 45%;margin-bottom: 15px;">
                            <h3>Vision</h3>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                        <div class="welcome-haven-img fadeInRight wow text-left" data-wow-delay="0.2s">
                            <img src="images/mission.png" alt="Mission" style="width: 40%;margin-bottom: 15px;">
                            <h3>Mission</h3>
                ...
                <div class="row">
                        ...
                        <div class="property wow fadeInDown" data-wow-delay="0.2s">
                            <div class="property__inner">
                                <figure class="property__image">
                                    <a href="grand-arena-project.php" class="d-block" title="GRAND ARENA LAYOUT">
                                        <img src="images/ga-layout_new.png" alt="GRAND ARENA LAYOUT" title="GRAND ARENA LAYOUT" class="w-100" style="height: 194.5px;">
                                    </a>
                                </figure>
                                <div class="property__info text-left">
                                    <h3 class="property__title text-center">GRAND ARENA</h3>
                                    <div class="contact-us">
                                        <a href="grand-arena-project.php" style="" class="btn btn-warning btn-sm text-white" title="GRAND ARENA">View Details</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 mb-30">
                        <div class="property wow fadeInDown" data-wow-delay="0.3s">
                            <div class="property__inner">
                                <figure class="property__image">
                                    <a href="haritha-vanam-project.php" class="d-block" title="HARITHA VANAM LAYOUT">
                                        <img src="images/layout1.jpg" alt="HARITHA VANAM LAYOUT" title="HARITHA VANAM LAYOUT" class="w-100">
                                    </a>
                                </figure>
                                <div class="property__info text-left">
                                    <h3 class="property__title text-center">HARITHA VANAM</h3>
                                    <div class="contact-us">
                                        <a href="haritha-vanam-project.php" style="" class="btn btn-warning btn-sm text-white" title="HARITHA VANAM">View Details</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 mb-30">
                        <div class="property wow fadeInDown" data-wow-delay="0.4s">
                            <div class="property__inner">
                                <figure class="property__image">
                                    <a href="fortune-height-project.php" class="d-block" title="FORTUNE HEIGHTS LAYOUT">
                                        <img src="images/fh-layout.jpeg" alt="FORTUNE HEIGHTS LAYOUT" title="FORTUNE HEIGHTS LAYOUT" class="w-75" style="display: block;margin: auto;height: 194.5px;">
                                    </a>
                                </figure>
                                <div class="property__info text-left">
                                    <h3 class="property__title text-center">FORTUNE HEIGHTS</h3>
                                    <div class="contact-us">
                                        <a href="fortune-height-project.php" style="" class="btn btn-warning btn-sm text-white" title="FORTUNE HEIGHTS">View Details</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 mb-30">
                        <div class="property wow fadeInDown" data-wow-delay="0.4s">
                            <div class="property__inner">
                                <figure class="property__image">
                                    <a href="ramchandra-divine-county.php" class="d-block" title="JP DARGAH VENTURE">
                                        <img src="images/ramchandra/feature-image.png" alt="JP DARGAH VENTURE" title="RAMCHANDRA DIVINE COUNTY LAYOUT" class="w-100" style="width:100%">
                                    </a>
                                </figure>
                                <div class="property__info text-left">
                                    <h3 class="property__title text-center">RAMCHANDRA DIVINE COUNTYE</h3>
                                    <div class="contact-us">
                                        <a href="ramchandra-divine-county.php" style="" class="btn btn-warning btn-sm text-white" title="RAMCHANDRA DIVINE COUNTY">View Details</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <ul class="nav nav-tabs justify-content-center" id="featuredProTab" role="tablist">
                                    <li class="nav-item wow fadeInLeft" style="margin-bottom: 10px;">
                                        <a class="nav-link active" id="featured-tab-1" data-toggle="tab"
                                            ...
                                            <img src="images/grand-arena/slide2-small.jpg" alt="Swimming Pool" title="Swimming Pool" >
                                        </a>
                                    </li>
                                    <li class="nav-item wow fadeInUp" style="margin-bottom: 10px;">
                                        <a class="nav-link" id="featured-tab-2" data-toggle="tab" href="#featured-2"
                                            ...
                                            <img src="images/grand-arena/slide1-small.jpg" alt="Tennis Court">
                                        </a>
                                    </li>
                                    <li class="nav-item wow fadeInRight" style="margin-bottom: 10px;">
                                        <a class="nav-link" id="featured-tab-3" data-toggle="tab" href="#featured-3"
                                            ...
                                            <img src="images/grand-arena/slide3-small.jpg" alt="Cricket Stadium">
                                        </a>
                                    </li>
                                    <li class="nav-item wow fadeInRight" style="margin-bottom: 10px;">
                                        <a class="nav-link" id="featured-tab-4" data-toggle="tab" href="#featured-4"
                                            ...
                                            <img src="images/grand-arena/slide4-small.jpg" alt="Cottages" >
                                        </a>
                                    </li>
                                    <li class="nav-item wow fadeInRight" style="margin-bottom: 10px;">
                                        <a class="nav-link" id="featured-tab-5" data-toggle="tab" href="#featured-5"
                                            ...
                                            <img src="images/grand-arena/slide5-small.jpg" alt="Conference Area" >
                                        </a>
                                    </li>
                                    <li class="nav-item wow fadeInRight" style="margin-bottom: 10px;">
                                        <a class="nav-link" id="featured-tab-6" data-toggle="tab" href="#featured-6"
                                            ...
                                            <img src="images/grand-arena/slide6-small.jpg" alt="Stadium Sitting Area" >
                                        </a>
                                    </li>
                                    <li class="nav-item wow fadeInRight" style="margin-bottom: 10px;">
                                        <a class="nav-link" id="featured-tab-7" data-toggle="tab" href="#featured-7"
                                            ...
                                            <img src="images/grand-arena/slide7-small.jpg" alt="Billiards" >
                                        </a>
                                    </li>
                                    <li class="nav-item wow fadeInRight" style="margin-bottom: 10px;">
                                        <a class="nav-link" id="featured-tab-8" data-toggle="tab" href="#featured-8"
                                            ...
                                            <img src="images/grand-arena/slide8-small.jpg" alt="Indoor Game Area" >
                                        </a>
                                    </li>
                                    <li class="nav-item wow fadeInRight" style="margin-bottom: 10px;">
                                        <a class="nav-link" id="featured-tab-9" data-toggle="tab" href="#featured-9"
                                            ...
                                            <img src="images/grand-arena/slide9-small.jpg" alt="Cottages Bed Room" >
                                        </a>
                                    </li>
                                    <li class="nav-item wow fadeInRight" style="margin-bottom: 10px;">
                                        <a class="nav-link" id="featured-tab-10" data-toggle="tab" href="#featured-10"
                                            ...
                                            <img src="images/grand-arena/photo14-small.jpg" alt="Cottages Bed Room" >
                                        </a>
                                    </li>
                            ...
                            <div class="tab-content" id="featuredProTabContent">
                                <div class="tab-pane fade show active" id="featured-1" role="tabpanel"
                                    ...
                                    <figure class="featured-property__image">
                                        <img src="images/grand-arena/slide2.jpeg" alt="Swimming Pool">
                                ...
                                <div class="tab-pane fade" id="featured-2" role="tabpanel"
                                    ...
                                    <figure class="featured-property__image">
                                        <img src="images/grand-arena/slide1.jpeg" alt="Tennis Court">
                                ...
                                <div class="tab-pane fade" id="featured-3" role="tabpanel"
                                    ...
                                    <figure class="featured-property__image">
                                        <img src="images/grand-arena/slide3.jpeg" alt="Hyderabad Cricket Club">
                                ...
                                <div class="tab-pane fade" id="featured-4" role="tabpanel"
                                    ...
                                    <figure class="featured-property__image">
                                        <img src="images/grand-arena/slide4.jpeg" alt="Cottages">
                                ...
                                <div class="tab-pane fade" id="featured-5" role="tabpanel"
                                    ...
                                    <figure class="featured-property__image">
                                        <img src="images/grand-arena/slide5.jpeg" alt="Conference Area">
                                ...
                                <div class="tab-pane fade" id="featured-6" role="tabpanel"
                                    ...
                                    <figure class="featured-property__image">
                                        <img src="images/grand-arena/slide6.jpeg" alt="Stadium Sitting Area">
                                ...
                                <div class="tab-pane fade" id="featured-7" role="tabpanel"
                                    ...
                                    <figure class="featured-property__image">
                                        <img src="images/grand-arena/slide7.jpeg" alt="Billiards">
                                ...
                                <div class="tab-pane fade" id="featured-8" role="tabpanel"
                                    ...
                                    <figure class="featured-property__image">
                                        <img src="images/grand-arena/slide8.jpeg" alt="Indoor Game Area">
                                ...
                                <div class="tab-pane fade" id="featured-9" role="tabpanel"
                                    ...
                                    <figure class="featured-property__image">
                                        <img src="images/grand-arena/slide9.jpeg" alt="Cottage Bed Room">
                                ...
                                <div class="tab-pane fade" id="featured-10" role="tabpanel"
                                    ...
                                    <figure class="featured-property__image">
                                        <img src="images/grand-arena/photo14.jpg" alt="Clubhouse Entrance">
        ...
        <div class="happy-client pt-90 wow fadeInUp" data-wow-delay="0.3s" data-wow-duration="1.3s" style="">
            <div class="container">
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="register-page-form">
                        ...
                        <form action="#">
                            <div class="usernam">
                                <input type="text" placeholder="Full Name" id="full_name2">
                            </div>
                            <div class="emai">
                                <input type="email" placeholder="Email" id="email2">
                            </div>
                            <div class="number">
                                <input type="number" placeholder="Phone Number" id="phone2">
                            </div>
                            <div class="msg">
                                <!--<input type="password" placeholder="Password">-->
                                <textarea placeholder="Message" id="msg2"></textarea>
                            </div>
                            <div class="login">
                                <button type="button" id="popup_submit1">Submit</button>
                            </div>
                        </form>
                    </div>
                </div>
